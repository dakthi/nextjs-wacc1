...
INSERT INTO public.facilities VALUES (3, 'Main Hall', '120 Person Capacity • 9.81m × 12.64m', 'Spacious hall with outside paved area access, perfect for large events, parties, weddings, funerals, NHS courses, and community gatherings.', 120, '9.81m × 12.64m', 50.00, '["120 person capacity", "Outside paved area access", "Kitchen facilities included", "10 large rectangular tables", "80 chairs included", "Professional cleaning included"]', 'https://bucket-wacc1.f47d23c072e7b2f871ecca11e36e0b25.r2.cloudflarestorage.com/uploads/1755111433144_atrenu_WhatsApp_Image_2025-08-05_at_18.19.13.jpeg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=1b6772892999957d50aede7703a8627e%2F20250813%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250813T185713Z&X-Amz-Expires=604800&X-Amz-Signature=432af079d2700032e3e4a6d7373bf18027d81b46d0b8aff8de2a7f1cb50e22d2&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject', true, '2025-08-13 18:18:06.808', '2025-08-13 18:57:14.57');
...
INSERT INTO public.site_settings VALUES (4, 'main_hall_capacity', '120', 'number', 'Maximum capacity in Main Hall', '2025-08-13 18:57:36.324');
...
SELECT pg_catalog.setval('public.site_settings_id_seq', 67, true);
